...
- (IBAction)speakButton:(UIButton *)sender {
    ...
    if (sizeof(self.mySegmentedControl.selectedSegmentIndex) == sizeof(int)) {
        NSLog(@"Selected segmented index is: %d", (int)[self.mySegmentedControl selectedSegmentIndex]);
    } else if (sizeof(self.mySegmentedControl.selectedSegmentIndex) == sizeof(double)) {
        NSLog(@"Selected segmented index is: %f", (double)[self.mySegmentedControl selectedSegmentIndex]);
    }
